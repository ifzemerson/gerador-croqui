...
# Certifique-se de que o link abaixo é o exato link do seu Firebase
firebase_admin.initialize_app(cred, {
    'databaseURL': 'https://geradorcroqui-default-rtdb.firebaseio.com/'
})

# 2. A sua lista gigante
novos_tecnicos = {
    # --- AREA 15 ---
...
# 3. Faz o envio (A função "update" junta os novos com os velhos sem apagar nada)
ref = db.reference('/tecnicos')
ref.update(novos_tecnicos)

print("🚀 Todos os técnicos foram injetados no Firebase com sucesso!")